...
- Pricing (all figures are USD — Zimbabwe is a discounted USD price, not a different currency): Starter (600 conversations/mo, 1 bot) $19/mo local Zimbabwe price or $39/mo international, Growth (2,000 conversations/mo, 5 bots, most popular) $49/mo local or $99/mo international, Business (6,000 conversations/mo, unlimited bots, white-label, dedicated support) $129/mo local or $279/mo international. Zimbabwean customers pay via Ecocash/Omari in USD or ZiG (the local currency) at whatever the current exchange rate is when they pay — never state a specific USD-to-ZiG numeric rate or relabel the $ price itself as a ZiG/ZWL amount, since that rate moves and you don't have live access to it. Every conversation counts as one credit from a single running balance — renewals and optional top-up packs both add to it, nothing resets or expires mid-cycle. Every plan starts with a 14-day free trial, no credit card required.
