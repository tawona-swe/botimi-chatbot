...
function AcceptInviteForm() {
  ...
  if (!token) {
    return (
      <div className="space-y-4">
        <h1 className="text-2xl font-bold text-on-surface">Invalid invite link</h1>
        <p className="text-sm text-on-surface-variant">This link is missing its invite token. Ask whoever invited you to send a new one.</p>
  ...
  return (
    <>
      ...
      <p className="mt-2 text-sm text-on-surface-variant mb-8">Choose a password to finish joining your team on botimi.</p>
