...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-20 bg-white">
      {/* LEFT — LOGIN FORM */}
      <div className="lg:col-span-9 relative flex items-center justify-center px-8 lg:px-16 xl:px-24 py-12 bg-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md space-y-8">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-2 mb-8">
              <span className="text-lg font-bold text-primary">botimi</span>
            </Link>
          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-900 bg-gray-50/50 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white transition-all"
              />
              {errors.email && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl py-3 pr-12 pl-4 text-sm text-gray-900 bg-gray-50/50 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white transition-all"
                />
                <button
                  type="button"
