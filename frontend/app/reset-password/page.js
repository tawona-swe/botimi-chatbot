...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500">This password reset link is missing its token. Request a new one below.</p>
  ...
  return (
    <>
      ...
      <p className="mt-2 text-sm text-gray-500 mb-8">Choose a new password for your account.</p>
