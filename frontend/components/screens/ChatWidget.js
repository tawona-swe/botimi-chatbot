...
export default function ChatWidget() {
  ...
  return (
    <div className="dark bg-background text-on-background min-h-screen flex flex-col selection:bg-primary/20">
      <style>{`
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[9px] text-green-400/80">Online</span>
                      </div>
                    </div>
                  </div>
                    ...
                    {!isTyping && (
                      <div className="shrink-0 px-4 py-2 flex gap-1.5 overflow-x-auto scrollbar-thin border-t border-outline-variant/20">
                        {quickReplies.map((text) => (
                          <button key={text} className="shrink-0 px-3 py-1.5 text-[10px] font-medium rounded-full border border-outline-variant/40 text-on-surface-variant hover:bg-primary hover:border-primary hover:text-on-primary transition-all whitespace-nowrap">
                            {text}
                          </button>
                        ))}
                      </div>
                    ...
                    <div className="shrink-0 p-3 border-t border-outline-variant/20 bg-surface-container-low/30 rounded-br-xl">
                      <div className="flex items-center gap-2">
                        <div className="flex-1 relative">
                          ...
                          />
                          <button className="absolute right-1 top-1/2 -translate-y-1/2 w-6 h-6 bg-gradient-to-br from-primary to-secondary rounded flex items-center justify-center hover:scale-105 transition-all" onClick={() => setInputValue("")}>
